    ...
    protected void commandControl(KeyEvent ke){
        ...
        if(c=='\n'){
            ...
            if(!commandEnter.equals("")){
                ...
                tempCommand=tempCommand+1;
                //Systen.out.println(ll+" "+commandNum);
            }
            ...
            if(commandEnter.startsWith("urlinfo")||commandEnter.startsWith("urlinfo"))
            {
                ...
                while(tokenizer.hasMoreTokens()){
                    ...
                    try {
                        ...
                        ta.append(""+token+"avaliable data: \n");
            ...
            else if(commandEnter.startsWith("run") || commandEnter.startsWith("run"))
            {
                ...
                while(tokenizer.hasMoreTokens()){
                    ...
                    try {
                        ...
                        cannotRunFile=token;
                        ta.append("Error: can't run program "+cannotRunFile+"/n");
                    }
            ...
            else if(commandEnter.startsWith("whois")|| commandEnter.startsWith("whois"))
            {
                ...
                while(tokenizer.hasMoreTokens()){
                    ...
                    try {
                        ...
                        ta.append("Error: Can't fng server:"+cannotFindWhois+"\n");
                    }
                }
                //s.close();
                ta.append(currentPath+prompt);
            ...
            else if(commandEnter.startsWith("find")|| commandEnter.startsWith("find"))
            {
                ...
                ta.append(commandEnter+"\n");
                String token=tokenizer.nextToken();
                String ta_FileExists="",ta_FileDosNotExist="";
                ...
                while(tokenizer.hasMoreTokens()){
                    ...
                    try {
                        ...
                        if(findFile==true)
                        {
                            ...
                            ta_FileDosNotExist=ta_FileDosNotExist+token+"\n";
                        }
         ...
         //////////////////////////////////////////////////////////GREEN VIDEO//////////////////////////////////////////////////////////////   
            ...
            /////////////////////////////DIRECTORY////////////////////////////////////////////////////////////////////////
                ...
                try {
                    ...
                    p(dir.exists()?"":"The directory does'nt exists/n");
                    String [] fileNames;
                    fileNames=dir.list();
            ...
            //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                else if(commandEnter.startsWith("copy") || commandEnter.startsWith("copy"))
                {
                    ...
                    try {
                        ...
                        ta.append("Error: Can't execute 'copy' command./n");
                    }
                ...
                else if(commandEnter.startsWith("ren") || commandEnter.startsWith("ren"))
                {
                    ...
                    try {
                        ...
                        if(oldFile.exists()==false) ta.append("Error: File "+oldFile+"doesn't exist\n");
                ...
                else if(commandEnter.startsWith("local ")|| commandEnter.startsWith("local"))
                {
                    ...
                    try {
                        ...
                        ta.append("Usage: local -us(United Sates)\n");
                ...
                ////////////////////////////////////////////////////////HELP/////////////////////////////////////////////////////
                    ...
                    ta.append("cd       |Changes Directory       |cd program\n");
                    ...
                    ta.append("prompt   |Chnages prompt sign     |prompt>>>\n");
                    ta.append("urlinfo  |Gives URL informaton    |urlinfo http://www.yahoo.com\n");
                    ...
                    ta.append("ren      |Rename file             |ren oldName.txt newName.txt\n");
                    ...
                    ta.append("exit     |Exists from edit mode   |exit\n");
                    ta.append("help     |Shows help information  |help\n");
                    ta.append("?        |Shows help information  |?\n");
                    ta.append("whois    |Give information of site|whois internic.net dotcom.com\n");
                    ta.append("quit     |Quit NEt Demo/ Edit mode|quit\n\n");
